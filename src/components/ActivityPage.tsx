    ...
    <>
      ...
      >
          ...
          <div className="text-center mb-6 md:mb-8 relative z-10">
            <span className="block text-retro-pink font-hand text-2xl rotate-[-2deg] mb-2">{textConfig.letter.headerSubtitle}</span>
              ...
              >
                ...
                {!isEnvelopeOpen && (
                  <div className="text-center mt-6 animate-fade-in">
                    <p className="text-sm text-gray-700 mb-2 font-medium">{textConfig.letter.envelopeClickHint}</p>
                ...
                >
                  <div className="flex items-center justify-between mb-4 md:mb-6 pb-3 md:pb-4 border-b-2 border-primary/20 relative">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm md:text-base lg:text-lg font-bold text-primary">{textConfig.letter.letterHeaderTitle}</span>
                    </div>
                  </div>
